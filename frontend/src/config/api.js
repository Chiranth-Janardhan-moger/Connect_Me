...
export const API_ENDPOINTS = {
  ...
  ADMIN_NOTIFICATIONS_SEND_USER: '/api/notifications/send-user',
...
export const adminAPI = {
  ...
  sendNotification: async ({ role, title, body, data, sound, badge }) => {
    return await apiCall(API_ENDPOINTS.ADMIN_NOTIFICATIONS_SEND, {
      method: 'POST',
      body: JSON.stringify({ role, title, body, data, sound, badge }),
    });
  },
  sendNotificationToUser: async ({ userId, title, body, data, sound, badge }) => {
    return await apiCall(API_ENDPOINTS.ADMIN_NOTIFICATIONS_SEND_USER, {
      method: 'POST',
      body: JSON.stringify({ userId, title, body, data, sound, badge }),
    });
  },
  // App version (admin)
  getAppVersion: async () => {
    return await apiCall(API_ENDPOINTS.APP_VERSION, { method: 'GET' });
  },
  updateAppVersion: async ({ version, downloadUrl }) => {
    return await apiCall(API_ENDPOINTS.APP_VERSION, {
      method: 'PUT',
...
export const notificationAPI = {
  ...
  testNotification: async () => {
    return await apiCall(API_ENDPOINTS.NOTIFICATIONS_TEST, {
      method: 'POST',
    });
  },
};